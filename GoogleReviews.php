<?php
include "AlchInt.php";
$result=json_decode(file_get_contents("https://maps.googleapis.com/maps/api/place/textsearch/json?query=".urlencode($_GET['keywords'])."&sensor=false&key=AIzaSyAw3G2Nm0A7gDa8dzKm3UnBI6CPxIHkayo"),true)["results"];
$IDs=array();
